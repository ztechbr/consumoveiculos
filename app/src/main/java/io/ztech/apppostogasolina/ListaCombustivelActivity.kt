...
class ListaCombustivelActivity : AppCompatActivity() {
    ...
    // Variáveis temporárias para guardar o que veio da tela anterior
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1. Captura os dados enviados pela MainActivity (se houver)
        ...
        // 2. Se veio dados, aplica a pré-seleção inicial (Tipo e Uso)
        if (tipoVindo != null) {
    ...
    private fun configurarSpinners() {
        ...
        spTipoVeiculo.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                // Ao mudar o tipo, recarregamos as listas dependentes
    ...
    // Função auxiliar AJUSTADA para evitar o warning "Unchecked Cast"
    ...
    private fun calcularConsumo(tipo: String, motor: String, comb: String, uso: String): Double {
        if (tipo == "Moto") {
